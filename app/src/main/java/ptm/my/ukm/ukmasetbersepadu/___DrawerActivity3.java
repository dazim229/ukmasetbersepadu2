...
public class ___DrawerActivity3 extends AppCompatActivity
    ...
    ___DrawerActivity3 c = this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.___activity_drawer);
        ...
        ft.replace(R.id.fragment_container, ___RuangBangunanFragment.newInstance(user));
        ft.commit();
    }
