...
public class DrawerActivity extends AppCompatActivity
    ...
    DrawerLayout drawer;
    @Bind(R.id.fabMain)  FloatingActionMenu fabMain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ft.replace(R.id.fragment_container, ProfileFragment.newInstance(user));
        ft.commit();
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            ft.replace(R.id.fragment_container, ProfileFragment.newInstance(user));
            ft.commit();
        } else if (id == R.id.nav_master_list) {
            FragmentManager fragmentManager = getSupportFragmentManager();
            FragmentTransaction ft = fragmentManager.beginTransaction();
            ft.replace(R.id.fragment_container, AssetListFragment.newInstance());
            ft.commit();

        }else if (id == R.id.nav_scan_log) {
            FragmentManager fragmentManager = getSupportFragmentManager();
            FragmentTransaction ft = fragmentManager.beginTransaction();
        ...
        else if (id == R.id.nav_master_list_blok_by_idBangunan) {
            FragmentManager fragmentManager = getSupportFragmentManager();
            FragmentTransaction ft = fragmentManager.beginTransaction();
            ft.replace(R.id.fragment_container, RuangListFragment2.newInstance());
            ft.commit();
