...
public class ___RuangBangunanFragment extends Fragment {
...
//    @Bind(R.id.source1) ImageView source1;
    ...
    public static ___RuangBangunanFragment newInstance(User param1) {
        ___RuangBangunanFragment fragment = new ___RuangBangunanFragment();
    ...
    public ___RuangBangunanFragment() {
